...
B<Optional>. Speficies the request timeout in seconds.. this will be
...
the C<event> argument to C<rank()> method/event will recieve input
...
event/method. Will not be present if an error occured (see below).

=head2 C<error>

    { 'error' => 'No Data', }

If an error occured during the request, it will be present in the
...
Please report any bugs or feature requests to C<bug-poe-component-www-alexa-trafficrank at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-WWW-Alexa-TrafficRank>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc POE::Component::WWW::Alexa::TrafficRank
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-WWW-Alexa-TrafficRank>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-WWW-Alexa-TrafficRank>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-WWW-Alexa-TrafficRank>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-WWW-Alexa-TrafficRank>
